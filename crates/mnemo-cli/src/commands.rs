...
pub fn health(args: &[String]) -> Result<Option<String>, String> {
...
pub fn db_command(args: &[String]) -> Result<Option<String>, String> {
...
pub fn serve(args: &[String]) -> Result<Option<String>, String> {
...
pub fn event_command(args: &[String]) -> Result<Option<String>, String> {
    match args.first().map(String::as_str) {
        Some("add") => {
...
pub fn remember(args: &[String]) -> Result<Option<String>, String> {
    let body = json!({
        "namespace": namespace_json(args)?,
...
pub fn context(args: &[String]) -> Result<Option<String>, String> {
...
pub fn thread_command(args: &[String]) -> Result<Option<String>, String> {
...
pub fn policy_command(args: &[String]) -> Result<Option<String>, String> {
    match args.first().map(String::as_str) {
        Some("get") => {
...
pub fn wrapup(args: &[String]) -> Result<Option<String>, String> {
    let body = json!({
        "namespace": namespace_json(args)?,
        "q": flag_value(args, "--q"),
...
pub fn job_command(args: &[String]) -> Result<Option<String>, String> {
    match args.first().map(String::as_str) {
        Some("get") => {
...
pub fn memory_command(args: &[String]) -> Result<Option<String>, String> {
    match args.first().map(String::as_str) {
        Some("get") => {
...
pub fn summary_command(args: &[String]) -> Result<Option<String>, String> {
    match args.first().map(String::as_str) {
        Some("get") => {
...
pub fn usage_command(args: &[String]) -> Result<Option<String>, String> {
    match args.first().map(String::as_str) {
        Some("report") => {
            let body = json!({
                "namespace": namespace_json(args)?,
...
pub fn conflict_command(args: &[String]) -> Result<Option<String>, String> {
    match args.first().map(String::as_str) {
        Some("search") => {
            let body = json!({
                "namespace": namespace_json(args)?,
...
pub fn worker_command(args: &[String]) -> Result<Option<String>, String> {
    match args.first().map(String::as_str) {
...
fn worker_run_loop(args: &[String]) -> Result<Option<String>, String> {
    ...
    if max_jobs == Some(0) {
        return Ok(Some(
            worker_run_summary(processed_jobs, failed_jobs, idle_polls, iterations, "max_jobs", last_job_id)
                .to_string(),
        ));
    }
...
pub fn forget(args: &[String]) -> Result<Option<String>, String> {
